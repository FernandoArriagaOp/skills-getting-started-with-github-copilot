...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim practice, technique improvement, and friendly meets",
    ...
    "Art Workshop": {
        ...
        "max_participants": 15,
        "participants": ["isabel@mergington.edu", "maria@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting, stagecraft, and preparing performances for the school",
    ...
    "Science Club": {
        "description": "Explore experiments and science projects across disciplines",
